		...
		<view class="main">
			...
			<view class="inputs">
				<view class="inputs-div">
					<input type="text" placeholder="请取个名字" class="user" placeholder-style="color:#bbb;font-weighht:400;" @input="getUser" />
					<view class="employ" v-if="useremploy">已占用</view>
					<image src="../../static/images/signup/right1.png" class="ok" v-if="isuser"></image>
				</view>
				<view class="inputs-div">
					<input type="text" placeholder="请输入邮箱" class="email" placeholder-style="color:#bbb;font-weighht:400;" @input="isEmail" />
				...
				<view class="inputs-div">
					<input :type="type" placeholder="这是输入密码" class="psw"placeholder-style="color:#bbb;font-weighht:400;" @input="getPsw" />
